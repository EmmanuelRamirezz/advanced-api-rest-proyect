//En esta seccion estarán los nodos de nuestro hmtl. Todos los query selectors que usaremos en otros archivos.
...
const movieDetailSelection = document.querySelector('#movieDetail');
